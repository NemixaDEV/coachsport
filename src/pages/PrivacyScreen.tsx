          ...
          <div className="flex items-start mb-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-muted-foreground text-sm space-y-2">
                <p>
                  En CoachSport, nos comprometemos a proteger tu privacidad y la
                  seguridad de tus datos personales. Esta política describe cómo
                ...
                <ul className="list-disc list-inside ml-2 space-y-1">
                  ...
                  <li>
                    Información de perfil (foto, objetivos de entrenamiento)
                  </li>
                  <li>
                    Datos de entrenamiento (rutinas, progreso, mediciones)
                  </li>
                ...
                <p>
                  Solo compartimos tu información con tu entrenador asignado y
                  con tu consentimiento explícito. No vendemos ni alquilamos tus
        ...
        <Card className="mb-4">
          <div className="flex items-start mb-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-muted-foreground text-sm space-y-2">
                <p>
                  Al usar CoachSport, aceptas los siguientes términos y
                  condiciones de uso.
                </p>
                <p>
                  <strong className="text-foreground">
                ...
                <ul className="list-disc list-inside ml-2 space-y-1">
                  <li>
                    Debes ser mayor de 18 años o tener consentimiento de un
                    tutor
                  </li>
                  <li>
                ...
                <p>
                  CoachSport no se hace responsable de lesiones o daños
                  resultantes del uso de las rutinas de entrenamiento. Siempre
                  consulta con un profesional médico antes de comenzar cualquier
          ...
          <div className="flex items-start mb-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-muted-foreground text-sm space-y-2">
                ...
                <ul className="list-disc list-inside ml-2 space-y-1">
                  <li>
                    Tus datos se almacenan en servidores seguros con
                    encriptación SSL
                  </li>
                  <li>
                ...
                <p>
                  Conservamos tus datos personales mientras tu cuenta esté
                  activa o según sea necesario para proporcionar nuestros
                  servicios. Puedes solicitar la eliminación de tus datos en
                  cualquier momento.
                </p>
                <p>
                ...
                <p>
                  Para ejercer tus derechos o hacer preguntas sobre el manejo de
                  tus datos, contacta a: privacidad@coachsport.dev
                </p>
              </div>
            </div>
          </div>
