...
const RECIPIENT_TYPES: {
...
}[] = [
  {
    ...
    description:
      'Para consultas sobre servicios, suscripciones, entrenadores, etc.',
  },
  {
    value: 'developers',
    label: 'Desarrolladores de la aplicación',
    description: 'Para reportar bugs, problemas técnicos, mejoras, etc.',
  },
]
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-muted-foreground mb-6">
              Hemos recibido tu mensaje para{' '}
              <strong className="text-foreground">
                {recipientType === 'admin'
                  ? 'el administrador del negocio'
                  : 'los desarrolladores de la aplicación'}
              </strong>
              . Nos pondremos en contacto contigo a la brevedad posible en{' '}
              <strong className="text-foreground">{email}</strong>.
            </p>
            <p className="text-sm text-muted-foreground mb-6">
              Gracias por contactarnos.
            </p>
            <Button onClick={() => navigate('/login')} className="w-full mb-4">
      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="mb-6">
          <p className="text-muted-foreground text-sm mb-6">
            Envíanos un mensaje si tienes algún problema, sugerencia o
            comentario. Estaremos encantados de ayudarte.
          </p>
