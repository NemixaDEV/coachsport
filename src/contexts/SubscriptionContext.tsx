...
export const useSubscription = () => {
  ...
  if (!context) {
    throw new Error(
      'useSubscription debe usarse dentro de SubscriptionProvider',
    )
  }
  return context
}
...
function checkActiveSubscription(user: User | null): boolean {
  ...
  if (!user.subscription) {
    // console.log(
    //   '[checkActiveSubscription] Usuario sin suscripción:',
    //   user.email,
    // )
    return false
  }
...
export const SubscriptionProvider = ({
  ...
  const subscriptionData = useMemo(() => {
    // console.log(
    //   '[SubscriptionProvider] Recalculando suscripción para:',
    //   user?.email,
    // )
